...
const (
	...
	// ElasticEnableResourceTypeUpdate allows to update resource type in standard operation
	// when delete resource type: from child to parent
	// when add resource type: from parent to child
	ElasticEnableResourceTypeUpdate featuregate.Feature = "ElasticEnableResourceTypeUpdate"
...
var defaultFeatureGates = map[featuregate.Feature]featuregate.FeatureSpec{
	...
	ElasticEnableResourceTypeUpdate:        {Default: false, PreRelease: featuregate.Alpha},
